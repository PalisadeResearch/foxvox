 ...
 */
export function fetch_from_object_store(db_name: string, store_name: string): Promise<(NodeData | GeneratedNode)[]> {
    return new Promise((resolve, reject) => {
 ...
 */
export function push_to_object_store(db_name: string, store_name: string, data: (NodeData | GeneratedNode)[]): Promise<string> {
    return new Promise((resolve, reject) => {
    ...
    return new Promise((resolve, reject) => {
        ...
        request.onsuccess = function (event: Event) {
            ...
            for (let i = 0; i < db.objectStoreNames.length; i++) {
                ...
                requests.push(new Promise<void>((res, rej) => {
